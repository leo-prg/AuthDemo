...
namespace RentAuthentication.Server.Services
{
    public class UserAuthService : IUserAuthService
    {
        ...
        public UserAuthService(UserManager<RentUser> userManager, 
        ...
        public RentUser GetUser(string Id)
        {
        ...
        public IEnumerable<RentUser> GetUsers()
        {
        ...
        private LoginResult GetLoginResult(RentUser user)
        {
            //DateTime dtExpire = DateTime.UtcNow.AddMinutes(1);
            DateTime dtExpire = DateTime.UtcNow.AddDays(30);
            return new LoginResult()
            {
                UserId = user.Id,
